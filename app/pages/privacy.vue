      ...
      <div class="col">
        ...
        <div class="descr">
          ...
          <span
            ...
            >Ивановым Иваном Ивановичем</span
          >
          (далее&nbsp;— Оператор).
        </div>
        <div class="ol">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="data-field">
                    <ul>
                      <li>
                        <span class="mark link">философские убеждения</span>
                      </li>
                    </ul>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="types-field">
                    <ul>
                      <li>
                        <span class="mark link"
                          >Передача персональных данных</span
                        >
                      </li>
                    </ul>
                  </td>
