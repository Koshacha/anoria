...
<template>
  <div>
    ...
    <p>Тарифы на услуги по созданию сайтов и приложений</p>
    <app-table :headers="['Тариф', 'Старт', 'Бизнес', 'PRO']">
      <tr>
        <td>Функционал</td>
        <td>
          Лендинг/сайт-визитка<br />
        ...
        <td>
          ...
          UI/UX-дизайн<br />
          Формы обратной связи и интеграции<br />
          Аналитика и цели
        </td>
        <td>
          Сложный сайт с товарами<br />
          Корзина + онлайн-оплата + доставка<br />
          Импорт/экспорт товаров<br />
          Настройка CRM/1С
        </td>
      </tr>
      <tr>
    ...
    <p>Тарифы на услуги по поддержке сайтов и приложений</p>
    <app-table :headers="['Тариф', 'Старт', 'Бизнес', 'PRO']">
      <tr>
        <td>Функционал</td>
        <td>
          Техническая поддержка (контроль работы сайта, резервные копии)<br />
          Мелкие правки (тексты, изображения, 1 час в месяц)<br />
          Обновления CMS и плагинов<br />
          Мониторинг доступности сайта
        </td>
        <td>
          Всё из «Базового»<br />
          Доработки функционала (до 3 часов в месяц)<br />
          Контроль безопасности (SSL, защита от спама и атак)<br />
          Настройка аналитики и отчёты
        </td>
        <td>
          Всё из «Бизнеса»<br />
          Наполнение контентом (новости, статьи, товары)<br />
          Интеграции (CRM, платежные системы, маркетплейсы)<br />
    ...
    <p>Тарифы на услуги продвижения</p>
    <app-table :headers="['Тариф', 'Старт', 'Бизнес', 'PRO']">
      <tr>
        <td>Функционал</td>
        <td>
          Подбор ключей, базовая оптимизация, тех. SEO<br />
          Написание текстов (до 4 статей/мес)<br />
          Первые результаты через 2–3 месяца
        </td>
        <td>
          Всё из «Старт»<br />
          Контекстная реклама (Яндекс/Google)<br />
          Постоянная оптимизация кампаний<br />
          Настройка целей в аналитике
        </td>
        <td>
          SEO + Реклама + SMM<br />
          Контент-план и ведение соцсетей<br />
          Инфлюенс-маркетинг, ретаргетинг<br />
          Ежемесячные отчёты и консультации
        </td>
      </tr>
      <tr>
        <td>Цена</td>
    ...
    <app-table :headers="['Тариф', 'Базовый', 'Оптимум', 'Премиум']">
      <tr>
        ...
        <td>до 250 входящих в месяц</td>
        <td>до 500 входящих</td>
